SELECT * FROM main.create_or_replace_feature ('4b195a43-b929-4d65-8a44-420f83475bae', 'search for pokemons', 'searching for pokemons is a fun activity', '{"pokemon", "search"}');
SELECT * FROM main.create_or_replace_scenario ('7a92a064-add8-4be3-a764-960798fea22d', 'in the park', 'walking in the park is healthy', '{"park"}', '4b195a43-b929-4d65-8a44-420f83475bae');
